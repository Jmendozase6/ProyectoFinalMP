...
public class FrmAgregarProducto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtxtPrecioUni.setFont(new java.awt.Font("Montserrat", 0, 14)); // NOI18N
        ...
        lblUs.setText("Marca");
        jPanel2.add(lblUs, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 270, -1, -1));

        lblCon.setFont(new java.awt.Font("Montserrat", 0, 18)); // NOI18N
        lblCon.setForeground(new java.awt.Color(0, 0, 0));
        lblCon.setText("Precio unitario");
        jPanel2.add(lblCon, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 330, -1, -1));

        lblUs1.setFont(new java.awt.Font("Montserrat", 0, 18)); // NOI18N
        lblUs1.setForeground(new java.awt.Color(0, 0, 0));
        lblUs1.setText("Cantidad");
        jPanel2.add(lblUs1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 390, -1, -1));

        lblCon1.setFont(new java.awt.Font("Montserrat", 0, 18)); // NOI18N
        lblCon1.setForeground(new java.awt.Color(0, 0, 0));
        lblCon1.setText("Proveedor");
        jPanel2.add(lblCon1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 450, -1, -1));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgProducto/btnAgregar.png"))); // NOI18N
        ...
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 510, -1, -1));
    ...
    public boolean agregarProducto() {
        ...
        java.sql.Date date2 = new java.sql.Date(dia.getTime());
        
        String SQL = "INSERT INTO productos (Nombre,Marca,Precio_unitario,Cantidad,Proveedor,Fecha_entrada) values(?,?,?,?,?,?)";
