...
public class FrmDatosPersonales extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbtnGuardarCambios1 = new javax.swing.JButton();
        ...
        jbtnGuardarCambios1.setFont(new java.awt.Font("Montserrat Medium", 0, 18)); // NOI18N
        jbtnGuardarCambios1.setForeground(new java.awt.Color(255, 255, 255));
        jbtnGuardarCambios1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/btnIniciarSesion.png"))); // NOI18N
        jbtnGuardarCambios1.setText("Guardar cambios");
        jbtnGuardarCambios1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jbtnGuardarCambios1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jbtnGuardarCambios1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtnGuardarCambios1ActionPerformed(evt);
            }
        });
        jPanel2.add(jbtnGuardarCambios1, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 610, 250, 40));
    ...
    private void jbtnGuardarCambios1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnGuardarCambios1ActionPerformed
        if (verificarCampos()) {
            guardarCambios();
        }
    }//GEN-LAST:event_jbtnGuardarCambios1ActionPerformed
    ...
    private void guardarCambios() {
        ...
        contrasena = String.valueOf(jtxtContrasena.getPassword());
    ...
    private void mostrarDatos() {
        ...
        SQL = "SELECT * FROM usuarios where Usuario ='" + us.getUsuario() + "' and Contrasena='" + us.getContrasena() + "'";
        try {
    ...
    private javax.swing.JButton jbtnGuardarCambios1;
